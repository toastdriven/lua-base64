...
function to_base64(to_encode)
    ...
    if math.mod(string.len(bit_pattern), 3) == 2 then   # use math.fmod if using LUA 5.1+
        trailing = '=='
        bit_pattern = bit_pattern .. '0000000000000000'
    elseif math.mod(string.len(bit_pattern), 3) == 1 then   # use math.fmod if using LUA 5.1+
        trailing = '='
